...
excerpt: "Hope for the best, prepare for the worst. Our comprehensive incident response planning services ensure you're ready for whatever cyber threats come your way with tailored strategies, realistic testing, and detailed playbooks."
header:
  overlay_image: /assets/images/service-incident-response.jpg
  teaser: /assets/images/service-incident-response.jpg
  overlay_filter: 0.5
toc: true
---
...
<div style="text-align: center; margin: 3rem 0;">
  <a href="/contact" class="btn btn--primary btn--large">Prepare Your Incident Response</a>
  <br><br>
  <a href="/blog" class="btn btn--info">Read Our Incident Response Insights</a>
</div>

## Related Resources

### Blog Posts
- [From Plan to Playbook](/blog/From-plan-to-playbook/)
- [OT Incident Response Planning: Beyond Traditional Playbooks](/blog/ot-incident-response-planning-beyond-traditional-playbooks/)
- [Cyber Incident Reporting for Critical Infrastructure Act: CIRCIA](/blog/Cyber-Incident-Reporting-for-Critical-Infrastructure-Act-CIRCIA/)
- [Why Your Phishing Simulations Might Be Hurting More Than Helping](/blog/Why-Your-Phishing-Simulations-Might-Be-Hurting-More-Than-Helping/)

### Training
- [Detection Engineering Bootcamp](/training/detection-engineering-bootcamp)
- [Custom Training Programs](/training/custom-training)

### Related Services
- [OT Managed Detection and Response](/services/ot-managed-detection-response)
- [Network Security Assessments](/services/network-security-assessments)
- [Threat Modelling and Attack Path Mapping](/services/threat-modelling-attack-path-mapping)